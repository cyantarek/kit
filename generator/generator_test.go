...
func setDefaults() {
	viper.SetDefault("gk_service_path_format", path.Join("%s", "internal", "service"))
	viper.SetDefault("gk_cmd_service_path_format", path.Join("%s", "cmd", "service"))
	viper.SetDefault("gk_cmd_path_format", path.Join("%s", "cmd"))
	viper.SetDefault("gk_endpoint_path_format", path.Join("%s", "internal", "endpoint"))
	viper.SetDefault("gk_http_path_format", path.Join("%s", "internal", "http"))
	...
	viper.SetDefault("gk_grpc_path_format", path.Join("%s", "internal", "grpc"))
	viper.SetDefault("gk_grpc_pb_path_format", path.Join("%s", "internal", "grpc", "pb"))
